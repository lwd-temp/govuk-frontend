...
This change was introduced in [pull request #4567: Add `beforeInput` and `afterInput` options to form groups](https://github.com/alphagov/govuk-frontend/pull/4567).
